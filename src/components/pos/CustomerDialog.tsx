...
const CustomerDialog: React.FC<CustomerDialogProps> = ({
  ...
  const [formData, setFormData] = useState<Partial<Customer>>({
    ...
    phone: '',
    address: '',
    type_organization_id: 2, // 1=Jurídica, 2=Natural
  ...
  const validateForm = (): boolean => {
    ...
    // Required per DIAN Resolución 0165 de 2023: name, identification_number, email
          ...
          <Grid container spacing={2}>
                  ...
                  onChange={(e) => {
                    ...
                    if (newType === 'NIT') {
                      setFormData({
                        ...
                        type_organization_id: 1, // NIT defaults to Persona Jurídica
                      ...
                      setFormData({
                        ...formData,
                        identification_type: newType,
                        type_organization_id: 2, // Non-NIT defaults to Persona Natural
                        type_regime_id: undefined,
                        type_liability_id: undefined,
                        municipality_id: undefined,
                        dv: undefined,
            ...
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth>
                ...
                <Select
                  value={formData.type_organization_id || 2}
                  onChange={(e) => setFormData({ ...formData, type_organization_id: Number(e.target.value) })}
              ...
              <>
                <Grid item xs={12}>
                  <Alert severity="info" sx={{ mb: 1 }}>
                    Campos adicionales para facturación electrónica DIAN
                  </Alert>
                </Grid>
                <Grid item xs={12} sm={4}>
                  <FormControl fullWidth size="small">
                    ...
                    <Select
                      ...
                      onChange={(e) => {
                        setFormData({ ...formData, type_regime_id: Number(e.target.value) });
                      }}
                      label="Tipo Régimen"
                    >
                ...
                <Grid item xs={12} sm={4}>
                  <FormControl fullWidth size="small">
                    ...
                    <Select
                      ...
                      onChange={(e) => {
                        setFormData({ ...formData, type_liability_id: Number(e.target.value) });
                      }}
                ...
                <Grid item xs={12} sm={4}>
                  <FormControl fullWidth size="small">
                    ...
                    <Select
                      ...
                      onChange={(e) => {
                        setFormData({ ...formData, municipality_id: Number(e.target.value) });
                      }}
                      label="Municipio"
                    >
