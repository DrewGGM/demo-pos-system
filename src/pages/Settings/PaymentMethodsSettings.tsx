  ...
  const handleOpenDialog = (method?: PaymentMethod) => {
    if (method) {
      ...
      setFormData({
        ...
        affects_cash_register: method.affects_cash_register !== false,
        show_in_cash_summary: method.show_in_cash_summary !== false,
        show_in_reports: method.show_in_reports !== false,
